...
class AdminApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['statisticsPost'] to see the possible values for this operation
     *
     * @throws \Tripartie\SafeCheckout\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function statisticsPost($statisticWrite = null, string $contentType = self::contentTypes['statisticsPost'][0])
    {
        list($response) = $this->statisticsPostWithHttpInfo($statisticWrite, $contentType);
        return $response;
    }
     ...
     */
    public function statisticsPostWithHttpInfo($statisticWrite = null, string $contentType = self::contentTypes['statisticsPost'][0])
    {
        $request = $this->statisticsPostRequest($statisticWrite, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function statisticsPostAsync($statisticWrite = null, string $contentType = self::contentTypes['statisticsPost'][0])
    {
        return $this->statisticsPostAsyncWithHttpInfo($statisticWrite, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function statisticsPostAsyncWithHttpInfo($statisticWrite = null, string $contentType = self::contentTypes['statisticsPost'][0])
    {
        $returnType = '\Tripartie\SafeCheckout\Model\StatisticRead';
        $request = $this->statisticsPostRequest($statisticWrite, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function statisticsPostRequest($statisticWrite = null, string $contentType = self::contentTypes['statisticsPost'][0])
    {
