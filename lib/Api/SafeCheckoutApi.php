...
class SafeCheckoutApi
{
     ...
     * @return \Tripartie\SafeCheckout\Model\OfferPostCreationRead|\Tripartie\SafeCheckout\Model\InvalidQueryError|\Tripartie\SafeCheckout\Model\UnprocessableEntity|\Tripartie\SafeCheckout\Model\AuthError|\Tripartie\SafeCheckout\Model\AccessError|\Tripartie\SafeCheckout\Model\RateLimitError|\Tripartie\SafeCheckout\Model\GenericError
     */
    public function apiUsersIdoffersPost($id, $offerSoloWrite, string $contentType = self::contentTypes['apiUsersIdoffersPost'][0])
    {
        list($response) = $this->apiUsersIdoffersPostWithHttpInfo($id, $offerSoloWrite, $contentType);
        return $response;
    }
     ...
     * @return array of \Tripartie\SafeCheckout\Model\OfferPostCreationRead|\Tripartie\SafeCheckout\Model\InvalidQueryError|\Tripartie\SafeCheckout\Model\UnprocessableEntity|\Tripartie\SafeCheckout\Model\AuthError|\Tripartie\SafeCheckout\Model\AccessError|\Tripartie\SafeCheckout\Model\RateLimitError|\Tripartie\SafeCheckout\Model\GenericError, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiUsersIdoffersPostWithHttpInfo($id, $offerSoloWrite, string $contentType = self::contentTypes['apiUsersIdoffersPost'][0])
    {
        $request = $this->apiUsersIdoffersPostRequest($id, $offerSoloWrite, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiUsersIdoffersPostAsync($id, $offerSoloWrite, string $contentType = self::contentTypes['apiUsersIdoffersPost'][0])
    {
        return $this->apiUsersIdoffersPostAsyncWithHttpInfo($id, $offerSoloWrite, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiUsersIdoffersPostAsyncWithHttpInfo($id, $offerSoloWrite, string $contentType = self::contentTypes['apiUsersIdoffersPost'][0])
    {
        $returnType = '\Tripartie\SafeCheckout\Model\OfferPostCreationRead';
        $request = $this->apiUsersIdoffersPostRequest($id, $offerSoloWrite, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiUsersIdoffersPostRequest($id, $offerSoloWrite, string $contentType = self::contentTypes['apiUsersIdoffersPost'][0])
    {
