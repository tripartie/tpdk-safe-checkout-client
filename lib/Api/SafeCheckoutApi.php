...
class SafeCheckoutApi
{
     ...
     * @param  string $nature Filter on a specific value of nature (optional)
     * @param  string[] $nature2 Filter on a limited subset of nature (optional)
     * @param  string $condition Filter on a specific value of condition (optional)
     * @param  string[] $condition2 Filter on a limited subset of condition (optional)
    ...
    {
        $request = $this->apiOffersGetCollectionRequest($page, $title, $publicUrl, $publicUrl2, $unitPrice, $unitPrice2, $itemCount, $itemCount2, $createdAtBefore, $createdAtStrictlyBefore, $createdAtAfter, $createdAtStrictlyAfter, $metadata, $offerMetadata, $sellerMetadata, $nature, $nature2, $condition, $condition2, $status, $status2, $shippingAllowed, $contentType);
    ...
    {
        return $this->apiOffersGetCollectionAsyncWithHttpInfo($page, $title, $publicUrl, $publicUrl2, $unitPrice, $unitPrice2, $itemCount, $itemCount2, $createdAtBefore, $createdAtStrictlyBefore, $createdAtAfter, $createdAtStrictlyAfter, $metadata, $offerMetadata, $sellerMetadata, $nature, $nature2, $condition, $condition2, $status, $status2, $shippingAllowed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
