...
class TransactionApi
{
    ...
    /**
     * Operation apiQuotesUlidGet
     *
     * Retrieve a Quote
     *
     * @param  string $ulid Quote identifier (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiQuotesUlidGet'] to see the possible values for this operation
     *
     * @throws \Tripartie\SafeCheckout\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function apiQuotesUlidGet($ulid, string $contentType = self::contentTypes['apiQuotesUlidGet'][0])
    {
        list($response) = $this->apiQuotesUlidGetWithHttpInfo($ulid, $contentType);
        return $response;
    }

    /**
     * Operation apiQuotesUlidGetWithHttpInfo
     *
     * Retrieve a Quote
     *
     * @param  string $ulid Quote identifier (required)
     ...
     */
    public function apiQuotesUlidGetWithHttpInfo($ulid, string $contentType = self::contentTypes['apiQuotesUlidGet'][0])
    {
        $request = $this->apiQuotesUlidGetRequest($ulid, $contentType);
    ...
    /**
     * Operation apiQuotesUlidGetAsync
     *
     * Retrieve a Quote
     *
     * @param  string $ulid Quote identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiQuotesUlidGetAsync($ulid, string $contentType = self::contentTypes['apiQuotesUlidGet'][0])
    {
        return $this->apiQuotesUlidGetAsyncWithHttpInfo($ulid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiQuotesUlidGetAsyncWithHttpInfo
     *
     * Retrieve a Quote
     *
     * @param  string $ulid Quote identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiQuotesUlidGetAsyncWithHttpInfo($ulid, string $contentType = self::contentTypes['apiQuotesUlidGet'][0])
    {
        $returnType = '\Tripartie\SafeCheckout\Model\QuoteRead';
        $request = $this->apiQuotesUlidGetRequest($ulid, $contentType);
    ...
    /**
     * Create request for operation 'apiQuotesUlidGet'
     *
     * @param  string $ulid Quote identifier (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiQuotesUlidGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiQuotesUlidGetRequest($ulid, string $contentType = self::contentTypes['apiQuotesUlidGet'][0])
    {

        // verify the required parameter 'ulid' is set
        if ($ulid === null || (is_array($ulid) && count($ulid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ulid when calling apiQuotesUlidGet'
            );
        }


        $resourcePath = '/quotes/{ulid}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiQuotesUlidPatch'] to see the possible values for this operation
     *
     * @throws \Tripartie\SafeCheckout\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function apiQuotesUlidPatch($ulid, $quoteUpdate, string $contentType = self::contentTypes['apiQuotesUlidPatch'][0])
    {
        list($response) = $this->apiQuotesUlidPatchWithHttpInfo($ulid, $quoteUpdate, $contentType);
        return $response;
    }

    /**
     * Operation apiQuotesUlidPatchWithHttpInfo
     *
     * Update a Quote prior to issuing a Transaction
     *
     * @param  string $ulid Quote identifier (required)
     ...
     */
    public function apiQuotesUlidPatchWithHttpInfo($ulid, $quoteUpdate, string $contentType = self::contentTypes['apiQuotesUlidPatch'][0])
    {
        $request = $this->apiQuotesUlidPatchRequest($ulid, $quoteUpdate, $contentType);
    ...
    /**
     * Operation apiQuotesUlidPatchAsync
     *
     * Update a Quote prior to issuing a Transaction
     *
     * @param  string $ulid Quote identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiQuotesUlidPatchAsync($ulid, $quoteUpdate, string $contentType = self::contentTypes['apiQuotesUlidPatch'][0])
    {
        return $this->apiQuotesUlidPatchAsyncWithHttpInfo($ulid, $quoteUpdate, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiQuotesUlidPatchAsyncWithHttpInfo
     *
     * Update a Quote prior to issuing a Transaction
     *
     * @param  string $ulid Quote identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiQuotesUlidPatchAsyncWithHttpInfo($ulid, $quoteUpdate, string $contentType = self::contentTypes['apiQuotesUlidPatch'][0])
    {
        $returnType = '\Tripartie\SafeCheckout\Model\QuoteRead';
        $request = $this->apiQuotesUlidPatchRequest($ulid, $quoteUpdate, $contentType);
    ...
    /**
     * Create request for operation 'apiQuotesUlidPatch'
     *
     * @param  string $ulid Quote identifier (required)
     * @param  \Tripartie\SafeCheckout\Model\QuoteUpdate $quoteUpdate The updated Quote resource (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiQuotesUlidPatch'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiQuotesUlidPatchRequest($ulid, $quoteUpdate, string $contentType = self::contentTypes['apiQuotesUlidPatch'][0])
    {

        // verify the required parameter 'ulid' is set
        if ($ulid === null || (is_array($ulid) && count($ulid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ulid when calling apiQuotesUlidPatch'
            );
        }
        ...
        if ($quoteUpdate === null || (is_array($quoteUpdate) && count($quoteUpdate) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $quoteUpdate when calling apiQuotesUlidPatch'
            );
        }
