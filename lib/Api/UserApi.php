...
class UserApi
{
     ...
     */
    public function apiOffersGetCollection($page = 1, $title = null, $publicUrl = null, $publicUrl2 = null, $unitPrice = null, $unitPrice2 = null, $itemCount = null, $itemCount2 = null, $createdAtBefore = null, $createdAtStrictlyBefore = null, $createdAtAfter = null, $createdAtStrictlyAfter = null, $metadata = null, $offerMetadata = null, $sellerMetadata = null, $nature = null, $condition = null, $status = null, $shippingAllowed = null, string $contentType = self::contentTypes['apiOffersGetCollection'][0])
    {
        list($response) = $this->apiOffersGetCollectionWithHttpInfo($page, $title, $publicUrl, $publicUrl2, $unitPrice, $unitPrice2, $itemCount, $itemCount2, $createdAtBefore, $createdAtStrictlyBefore, $createdAtAfter, $createdAtStrictlyAfter, $metadata, $offerMetadata, $sellerMetadata, $nature, $condition, $status, $shippingAllowed, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->apiOffersGetCollectionRequest($page, $title, $publicUrl, $publicUrl2, $unitPrice, $unitPrice2, $itemCount, $itemCount2, $createdAtBefore, $createdAtStrictlyBefore, $createdAtAfter, $createdAtStrictlyAfter, $metadata, $offerMetadata, $sellerMetadata, $nature, $condition, $status, $shippingAllowed, $contentType);
    ...
    {
        return $this->apiOffersGetCollectionAsyncWithHttpInfo($page, $title, $publicUrl, $publicUrl2, $unitPrice, $unitPrice2, $itemCount, $itemCount2, $createdAtBefore, $createdAtStrictlyBefore, $createdAtAfter, $createdAtStrictlyAfter, $metadata, $offerMetadata, $sellerMetadata, $nature, $condition, $status, $shippingAllowed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiOffersUlidDelete
     *
     * Disable existing Offer
     *
     * @param  string $ulid Offer identifier (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiOffersUlidDelete'] to see the possible values for this operation
     *
     * @throws \Tripartie\SafeCheckout\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function apiOffersUlidDelete($ulid, string $contentType = self::contentTypes['apiOffersUlidDelete'][0])
    {
        $this->apiOffersUlidDeleteWithHttpInfo($ulid, $contentType);
    }

    /**
     * Operation apiOffersUlidDeleteWithHttpInfo
     *
     * Disable existing Offer
     *
     * @param  string $ulid Offer identifier (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiOffersUlidDeleteWithHttpInfo($ulid, string $contentType = self::contentTypes['apiOffersUlidDelete'][0])
    {
        $request = $this->apiOffersUlidDeleteRequest($ulid, $contentType);
    ...
    /**
     * Operation apiOffersUlidDeleteAsync
     *
     * Disable existing Offer
     *
     * @param  string $ulid Offer identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiOffersUlidDeleteAsync($ulid, string $contentType = self::contentTypes['apiOffersUlidDelete'][0])
    {
        return $this->apiOffersUlidDeleteAsyncWithHttpInfo($ulid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiOffersUlidDeleteAsyncWithHttpInfo
     *
     * Disable existing Offer
     *
     * @param  string $ulid Offer identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiOffersUlidDeleteAsyncWithHttpInfo($ulid, string $contentType = self::contentTypes['apiOffersUlidDelete'][0])
    {
        $returnType = '';
        $request = $this->apiOffersUlidDeleteRequest($ulid, $contentType);
    ...
    /**
     * Create request for operation 'apiOffersUlidDelete'
     *
     * @param  string $ulid Offer identifier (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiOffersUlidDelete'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiOffersUlidDeleteRequest($ulid, string $contentType = self::contentTypes['apiOffersUlidDelete'][0])
    {

        // verify the required parameter 'ulid' is set
        if ($ulid === null || (is_array($ulid) && count($ulid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ulid when calling apiOffersUlidDelete'
            );
        }
