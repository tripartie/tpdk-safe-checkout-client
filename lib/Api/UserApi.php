...
class UserApi
{
    ...
    /**
     * Operation apiProofOfIdentitiesIddocumentPost
     *
     * Upload the document for your PoI slot
     *
     * @param  float $id  (required)
     * @param  \SplFileObject $file file (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiProofOfIdentitiesIddocumentPost'] to see the possible values for this operation
     *
     * @throws \Tripartie\SafeCheckout\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function apiProofOfIdentitiesIddocumentPost($id, $file = null, string $contentType = self::contentTypes['apiProofOfIdentitiesIddocumentPost'][0])
    {
        list($response) = $this->apiProofOfIdentitiesIddocumentPostWithHttpInfo($id, $file, $contentType);
        return $response;
    }

    /**
     * Operation apiProofOfIdentitiesIddocumentPostWithHttpInfo
     *
     * Upload the document for your PoI slot
     *
     * @param  float $id  (required)
     ...
     */
    public function apiProofOfIdentitiesIddocumentPostWithHttpInfo($id, $file = null, string $contentType = self::contentTypes['apiProofOfIdentitiesIddocumentPost'][0])
    {
        $request = $this->apiProofOfIdentitiesIddocumentPostRequest($id, $file, $contentType);
    ...
    /**
     * Operation apiProofOfIdentitiesIddocumentPostAsync
     *
     * Upload the document for your PoI slot
     *
     * @param  float $id  (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiProofOfIdentitiesIddocumentPostAsync($id, $file = null, string $contentType = self::contentTypes['apiProofOfIdentitiesIddocumentPost'][0])
    {
        return $this->apiProofOfIdentitiesIddocumentPostAsyncWithHttpInfo($id, $file, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiProofOfIdentitiesIddocumentPostAsyncWithHttpInfo
     *
     * Upload the document for your PoI slot
     *
     * @param  float $id  (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiProofOfIdentitiesIddocumentPostAsyncWithHttpInfo($id, $file = null, string $contentType = self::contentTypes['apiProofOfIdentitiesIddocumentPost'][0])
    {
        $returnType = '\Tripartie\SafeCheckout\Model\ProofOfIdentityRead';
        $request = $this->apiProofOfIdentitiesIddocumentPostRequest($id, $file, $contentType);
    ...
    /**
     * Create request for operation 'apiProofOfIdentitiesIddocumentPost'
     *
     * @param  float $id  (required)
     * @param  \SplFileObject $file (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiProofOfIdentitiesIddocumentPost'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiProofOfIdentitiesIddocumentPostRequest($id, $file = null, string $contentType = self::contentTypes['apiProofOfIdentitiesIddocumentPost'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling apiProofOfIdentitiesIddocumentPost'
            );
        }



        $resourcePath = '/proof-of-identities/{id}/document';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
