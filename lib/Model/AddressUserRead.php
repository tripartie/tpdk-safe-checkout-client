 ...
 */
class AddressUserRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Address-UserRead';
    ...
    */
    ...
    public function setCountryCode($countryCode)
    {
        ...
        if ((mb_strlen($countryCode) > 3)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling AddressUserRead., must be smaller than or equal to 3.');
        }
