    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 250)) {
            throw new \InvalidArgumentException('invalid length for $title when calling OfferUpdate., must be smaller than or equal to 250.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 100000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling OfferUpdate., must be smaller than or equal to 100000.');
        }
