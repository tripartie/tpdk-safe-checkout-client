...
class OfferWrite implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['weightInGram']) && ($this->container['weightInGram'] > 10000)) {
            $invalidProperties[] = "invalid value for 'weightInGram', must be smaller than or equal to 10000.";
        }

        if (!is_null($this->container['weightInGram']) && ($this->container['weightInGram'] < 500)) {
    ...
    public function setWeightInGram($weightInGram)
    {
        ...
        if (($weightInGram > 10000)) {
            throw new \InvalidArgumentException('invalid value for $weightInGram when calling OfferWrite., must be smaller than or equal to 10000.');
        }
        if (($weightInGram < 500)) {
            throw new \InvalidArgumentException('invalid value for $weightInGram when calling OfferWrite., must be bigger than or equal to 500.');
        }
