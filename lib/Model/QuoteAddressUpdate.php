...
/**
 * QuoteAddressUpdate Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Tripartie\SafeCheckout
 ...
 */
class QuoteAddressUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Quote-Address-Update';
    ...
    */
    ...
    public function setCountryCode($countryCode)
    {
        ...
        if ((mb_strlen($countryCode) > 3)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling QuoteAddressUpdate., must be smaller than or equal to 3.');
        }
