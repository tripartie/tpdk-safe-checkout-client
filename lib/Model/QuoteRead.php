 ...
 */
class QuoteRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Quote-Read';
    ...
    protected static $openAPITypes = [
        ...
        'thirdPartyRecipientAddress' => '\Tripartie\SafeCheckout\Model\QuoteAddressRead',
        'createdAt' => '\DateTime',
        'expireAt' => '\DateTime',
        'iri' => 'string',
        'unitPrice' => 'float',
    ...
    */
    ...
    public function setThirdPartyRecipientFirstName($thirdPartyRecipientFirstName)
    {
        ...
        if (!is_null($thirdPartyRecipientFirstName) && (mb_strlen($thirdPartyRecipientFirstName) > 32)) {
            throw new \InvalidArgumentException('invalid length for $thirdPartyRecipientFirstName when calling QuoteRead., must be smaller than or equal to 32.');
        }
        if (!is_null($thirdPartyRecipientFirstName) && (mb_strlen($thirdPartyRecipientFirstName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $thirdPartyRecipientFirstName when calling QuoteRead., must be bigger than or equal to 1.');
        }
    ...
    public function setThirdPartyRecipientLastName($thirdPartyRecipientLastName)
    {
        ...
        if (!is_null($thirdPartyRecipientLastName) && (mb_strlen($thirdPartyRecipientLastName) > 32)) {
            throw new \InvalidArgumentException('invalid length for $thirdPartyRecipientLastName when calling QuoteRead., must be smaller than or equal to 32.');
        }
        if (!is_null($thirdPartyRecipientLastName) && (mb_strlen($thirdPartyRecipientLastName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $thirdPartyRecipientLastName when calling QuoteRead., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \Tripartie\SafeCheckout\Model\QuoteAddressRead|null
     */
     ...
     *
     * @param \Tripartie\SafeCheckout\Model\QuoteAddressRead|null $thirdPartyRecipientAddress thirdPartyRecipientAddress
     *
     * @return self
     */
     ...
     * Sets expireAt
     *
     * @param \DateTime|null $expireAt expireAt
     *
     * @return self
     */
