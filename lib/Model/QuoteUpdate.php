 ...
 */
class QuoteUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Quote-Update';
    ...
    protected static $openAPITypes = [
        ...
        'thirdPartyRecipientAddress' => '\Tripartie\SafeCheckout\Model\QuoteAddressUpdate'
    ];
    ...
    */
    ...
    public function setThirdPartyRecipientFirstName($thirdPartyRecipientFirstName)
    {
        ...
        if (!is_null($thirdPartyRecipientFirstName) && (mb_strlen($thirdPartyRecipientFirstName) > 32)) {
            throw new \InvalidArgumentException('invalid length for $thirdPartyRecipientFirstName when calling QuoteUpdate., must be smaller than or equal to 32.');
        }
        if (!is_null($thirdPartyRecipientFirstName) && (mb_strlen($thirdPartyRecipientFirstName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $thirdPartyRecipientFirstName when calling QuoteUpdate., must be bigger than or equal to 1.');
        }
    ...
    public function setThirdPartyRecipientLastName($thirdPartyRecipientLastName)
    {
        ...
        if (!is_null($thirdPartyRecipientLastName) && (mb_strlen($thirdPartyRecipientLastName) > 32)) {
            throw new \InvalidArgumentException('invalid length for $thirdPartyRecipientLastName when calling QuoteUpdate., must be smaller than or equal to 32.');
        }
        if (!is_null($thirdPartyRecipientLastName) && (mb_strlen($thirdPartyRecipientLastName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $thirdPartyRecipientLastName when calling QuoteUpdate., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \Tripartie\SafeCheckout\Model\QuoteAddressUpdate|null
     */
     ...
     *
     * @param \Tripartie\SafeCheckout\Model\QuoteAddressUpdate|null $thirdPartyRecipientAddress thirdPartyRecipientAddress
     *
     * @return self
     */
