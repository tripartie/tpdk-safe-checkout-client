...
class TransactionQuoteRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'thirdPartyRecipientAddress' => false,
        'createdAt' => false,
        'expireAt' => false,
        'iri' => false,
        'unitPrice' => true,
    ...
    */
     ...
     *
     * @param object|null $thirdPartyRecipientAddress 
     *
     * @return self
     */
    public function setThirdPartyRecipientAddress($thirdPartyRecipientAddress)
    {
        if (is_null($thirdPartyRecipientAddress)) {
            throw new \InvalidArgumentException('non-nullable thirdPartyRecipientAddress cannot be null');
        }
