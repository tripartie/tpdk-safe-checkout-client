...
/**
 * UserAddressAuthenticatedRead Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Tripartie\SafeCheckout
 ...
 */
class UserAddressAuthenticatedRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'User-Address-AuthenticatedRead';
    ...
    */
    ...
    public function setCountryCode($countryCode)
    {
        ...
        if ((mb_strlen($countryCode) > 3)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling UserAddressAuthenticatedRead., must be smaller than or equal to 3.');
        }
