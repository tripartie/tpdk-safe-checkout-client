...
class UserWrite implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['homeCountry'] === null) {
            $invalidProperties[] = "'homeCountry' can't be null";
        }
     ...
     * Sets originCountry
     *
     * @param string $originCountry The nationality of the current user.
     *
     * @return self
     */
     ...
     * Sets homeCountry
     *
     * @param string $homeCountry The originating country
     *
     * @return self
     */
